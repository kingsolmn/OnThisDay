...
package net.trs.onthisday.backend.endpointapi.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<net.trs.onthisday.backend.endpointapi.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, net.trs.onthisday.backend.endpointapi.myApi.model.MyBean.class);
